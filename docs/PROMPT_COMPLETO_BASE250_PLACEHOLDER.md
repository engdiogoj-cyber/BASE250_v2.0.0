# 📋 PROMPT COMPLETO - SISTEMA BASE250
...
6. **Dados do locador fixos** - LOCADOR_NOME já definido
...
ou: https://seudominio.com/BASE250
...
Sistema BASE250 - Gestão de Aluguel
─────────────────────────────────────────
```
...
Eu, abaixo assinado, Sr(a) LOCADOR_NOME, 
portador do CPF nº CPF_PLACEHOLDER, residente na Servidão 
Joaquim Soares, nº 250, bairro Itacorubi, Florianópolis/SC, 
telefone PHONE_PLACEHOLDER, declaro para os devidos fins de 
